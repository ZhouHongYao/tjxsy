  ...
  <div style="overflow-x: auto;">
    <div class="app-container">
      ...
      <div v-loading="loading" class="custom-tree-container" element-loading-text="数据载入中" style="min-width:700px">
        <el-tree ref="nodeTree" :data="tableData" :expand-on-click-node="false" :props="defaultProps" :filter-node-method="filterNode" :allow-drop="allowDrop" :allow-drag="allowDrag" class="filter-tree" default-expand-all
                 node-key="id" highlight-current empty-text="啊哦，您还没有添加内容哦！" draggable @node-drop="handleDrop">
