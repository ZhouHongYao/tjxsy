<template>
  <div>
    ...
    <NewEdit :pxpk-dialog="pxpkDialog" :kc-id="kcId" @CB-kc="CB_kc" />
    <!-- 详情-->
...
import NewEdit from "./pxpk";
import Detail from "./detail";
import { pxpkList, pxpkDel } from "@/api/dekt/lxxnjy/pxpk";
