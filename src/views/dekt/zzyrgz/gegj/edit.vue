  ...
  <div v-loading="listloading" class="createPost-container" element-loading-text="数据载入中">
    ...
    <div class="createPost-main-container">
      <el-form v-loading="listloading" ref="form" :model="form" :rules="rules" label-position="top" element-loading-text="数据载入中">
        <el-row>
          <el-col :span="24">
            <el-form-item label="接受资助后的感想（对老师、学校、社会、国家层面的）" prop="content">
              <el-input :autosize="{ minRows: 12, maxRows: 18}" v-model="form.content" type="textarea" maxlength="800" placeholder="请填写详细内容" />
              还可填写
...
import { gegjRead, gegjEdit } from "@/api/dekt/zzyrgz/gegj";
